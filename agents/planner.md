...
You apply the **superomni** planning framework: YAGNI for scope control, completeness for execution. You output structured `docs/superomni/plans/plan.md` files that other agents can execute step by step.
...
Output a `docs/superomni/plans/plan.md` using this structure:
...
Plan written to: docs/superomni/plans/plan.md
