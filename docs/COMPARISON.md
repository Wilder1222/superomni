...
**版本：** superomni v0.6.8 / superpowers latest / gstack latest  
**生成日期：** 2026-03-27  
**作者：** superomni 项目分析
...
**建议：** 在 `npm run gen-skills` 中自动更新文档版本号，或在 `ship` 技能的发布流程中包含文档版本同步检查。
...
*本文档基于 superomni v0.6.8、obra/superpowers 和 garrytan/gstack 的公开信息和代码库分析生成。*
