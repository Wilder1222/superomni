...
when_to_use: |
  Use when auditing dependencies for security (npm audit), outdated packages, or license compliance. Triggers: "dependency audit", "npm audit", "security scan", "outdated packages", "license check". Complements code-review (which audits application code, not deps).
produces: ~
consumes: ~
---
