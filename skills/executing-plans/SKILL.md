...
when_to_use: |
  Use after plan-review approves a plan. Walks the plan step-by-step with verification gates. Dispatches sub-agents in waves when steps are parallelizable.
produces: "docs/superomni/executions/execution-[branch]-[session]-[date].md"
consumes:
  - "docs/superomni/plans/plan-[branch]-[session]-[date].md"
  - "docs/superomni/reviews/review-[branch]-[session]-[date].md"
---
