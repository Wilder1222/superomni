...
- If the template file is unavailable, fallback to sections in `reference/design-md-adaptation.md` (Positioning, Quality Gate Mapping, Anti-Copy Guardrails) and keep output file names as `design-md-<brand>.md` and `prompt-design-md-<brand>.md`.
