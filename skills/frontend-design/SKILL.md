...
when_to_use: |
  Use when building UI, pages, or components. Guides context gathering → implementation → designer-agent quality gate at 7+/10. Triggers: "frontend design", "build UI", "design page".
produces: ~
consumes:
