...
when_to_use: |
  Use to audit or improve the agent harness: context efficiency, tool space, evaluation gates, feedback loops. Triggers on 3-strike agent failure signal or explicit harness audit request.
produces: "docs/superomni/harness-audits/harness-audit-[branch]-[session]-[date].md"
consumes: []
---
