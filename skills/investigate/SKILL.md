...
when_to_use: |
  Use for open-ended exploration of unfamiliar code: "how does X work", "map this system". Complements systematic-debugging (which requires a known error). NOT for known bugs — use systematic-debugging.
produces: ~
consumes: ~
