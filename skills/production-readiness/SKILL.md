...
when_to_use: |
  Use before deploying to production. Verifies observability, reliability, operability, security, goal alignment. The gate between "tests pass" and "safe to deploy".
