...
Fix:      Before any implementation task, spend 5 minutes writing docs/superomni/specs/spec.md with problem, goals, non-goals, acceptance criteria
...
REPORT_FILE="$IMPROVE_DIR/improvement-${BRANCH}-${SESSION}-${TIMESTAMP}.md"
```
