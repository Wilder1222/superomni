...
when_to_use: |
  Use on project initialization or when asked to capture style preferences. Output feeds brainstorm, executing-plans, code-review, self-improvement to keep outputs stylistically consistent.
