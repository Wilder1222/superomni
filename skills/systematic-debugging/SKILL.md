...
when_to_use: |
  Use for KNOWN errors, test failures, or unexpected behavior. Iron Law: no fix without root-cause investigation. NOT for open exploration — use investigate for that.
produces: ~
consumes: ~
